				...
				<tr>
					...
					<td class="cart-image">
						<a class="entry-thumbnail" href="detail.html">
						    <img src="admin/productimages/<?php echo $row['category'];?>/<?php echo $row['productImage1'];?>" alt="" width="114" height="146">
						</a>
					</td>
...
<div class="col-md-4 col-sm-12 cart-shopping-total">
	...
	<h4 style="color:purple;font-weight:bold;font-style:italic;letter-spacing:1px;text-shadow:0px 0px;">
