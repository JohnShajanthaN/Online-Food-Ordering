...
while($row=mysqli_fetch_array($sql))
{
    ?>
					...
					<div style="margin-left:-15PX;margin-top:-5px;font-weight:bold;font-size:22px;text-shadow:1px 1px black;">
	...
	<div class="product">	
		...
		<div class="product-image">
			<div class="image">
				...
				<img src="admin/productimages/<?php echo htmlentities($row['category']);?>/<?php echo htmlentities($row['productImage1']);?>" alt="" width="200" height="200">
				</a>
			</div><!-- /.image -->			                      		   
		</div><!-- /.product-image -->
